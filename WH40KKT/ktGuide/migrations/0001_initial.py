# Generated by Django 3.0.6 on 2020-07-13 19:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='guide',
            name='units',
            field=models.ManyToManyField(related_name='units', to='ktGuide.Unit'),
        ),
        migrations.AddField(
            model_name='guide',
            name='weapons',
            field=models.ManyToManyField(related_name='weapons', to='ktGuide.Weapon'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
